...
RYTHM_PATTERNS = [
    ...
    (EIGHTH, DEIGHTH, SIXTEENTH, SIXTEENTH, SIXTEENTH, EIGHTH, DEIGHTH, SIXTEENTH, SIXTEENTH, SIXTEENTH),
    (
        SIXTEENTH,
        SIXTEENTH,
        EIGHTH,
...
ENGINE_TYPE_ARP, ENGINE_TYPE_CHORD, ENGINE_TYPE_STRUM, ENGINE_TYPE_MELOTOR, ENGINE_TYPE_MELOSTEP = (
    0,
    1,
    2,
    3,
