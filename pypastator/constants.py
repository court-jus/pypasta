...
MENU_CC_STOP_RECORD = 5
MENU_CC_START_RECORD = 6
MENU_CC_OPEN_MENU = 7
# Midi CC increments for each track
ENGINE_CC_BASEVEL = 0
ENGINE_CC_PATTERN = 1
ENGINE_CC_RYTHM = 2
ENGINE_CC_PITCH = 3
...
CHORDS_MODE_PROGRESSION = 0
CHORDS_MODE_MANUAL_PLAY = 1
CHORDS_MODE_MANUAL_RECORD = 2
CHORDS_MODE_MANUAL = (CHORDS_MODE_MANUAL_PLAY, CHORDS_MODE_MANUAL_RECORD)
